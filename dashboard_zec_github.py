...
def vehicle_page():
         ...
         ax2.set_ylim([0, df.groupby('Weekday')["max verbruik in kWh 2040"].max()])
         ...
         ax3.set_ylim([0, df.groupby('Weekday')["max verbruik in kWh 2040"].max()])
         cols[2].pyplot(fig3)
         ...
         ax4.set_ylim([0, df.groupby('Hour')["max verbruik in kWh 2040"].max()])
         cols[3].pyplot(fig4)
